...
Note: `age_of_agents/mit_press_style.py` is build-time diagram tooling used to
produce the book's figures; it is not part of the runnable agent demos above.
